...
export const StockConference = () => {
  ...
  const renderSetup = () => (
    <div className="flex flex-col items-center justify-center p-6 mt-10">
      ...
      {errorMsg && (
        <div className="mb-6 p-4 bg-red-100 text-red-700 rounded-lg flex items-center w-full max-w-4xl">
      ...
      <button 
        ...
        className={`w-full max-w-md py-4 rounded-xl text-lg font-bold shadow-lg transition transform active:scale-95 flex items-center justify-center ${
