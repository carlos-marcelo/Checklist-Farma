...
const ProgressBar: React.FC<ProgressBarProps> = ({ percentage, label, size = 'md' }) => {
  ...
  return (
    <div className="w-full">
      <div className="flex justify-between mb-2 items-center">
        ...
        <span className={`text-[11px] font-black ${percentage >= 100 ? 'text-emerald-600' : 'text-slate-900'}`}>{Math.round(percentage)}%</span>
      </div>
